 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://clima.inifap.gob.mx/data/webservice.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://clima.inifap.gob.mx/data/webservice.asmx?wsdl");
